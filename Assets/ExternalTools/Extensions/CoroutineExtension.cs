...
public static class CoroutineExtension
{
    ...
    static IEnumerator DoActionFrame (Action[] action) {
    ...
    public static Coroutine InstantiateAndDestroyObjectAfterSometime (this MonoBehaviour monoBehaviour,GameObject _prefab,Vector3 position,Quaternion rotation,Transform parent,float destructionTime,Action onDestroyed) 
    {
        return monoBehaviour.StartCoroutine (InstantiateAndDestroyGameObjectAfterSometime (monoBehaviour, _prefab,position,rotation,parent,destructionTime,onDestroyed));
    }
    static IEnumerator InstantiateAndDestroyGameObjectAfterSometime(this MonoBehaviour monoBehaviour,GameObject _prefab,Vector3 position,Quaternion rotation,Transform parent,float actionWaitTime,Action onDestroyed)
    {
